...
const DEFAULT_RECIPES = [
  // -------- MILCHEIS — KLASSISCH --------
  {
    ...
    rows: [
      ...
      { ingId: "saccharose", qty: 75 },
      { ingId: "dextrose", qty: 35 },
      { ingId: "glukose-pulver", qty: 15 },
      { ingId: "inulin", qty: 12 },
      { ingId: "vanille-mark", qty: 3 },
    ],
    notes:
      "Optimiert · Inulin verbessert die Textur; Invertzucker wurde durch Dextrose/Trockenglukose ersetzt.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Optimiert · Hoher Kakaoanteil benötigt Inulin für bessere Bindung und Cremigkeit.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Optimiert · Haselnussfett wird durch Inulin und Trockenglukose in der Textur stabilisiert.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Optimiert · Reiner Geschmack, durch Inulin besonders zartschmelzend.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- MILCHEIS — MODERN --------
  {
    ...
    rows: [
      ...
      { ingId: "saccharose", qty: 70 },
      { ingId: "dextrose", qty: 30 },
      { ingId: "glukose-pulver", qty: 30 },
      { ingId: "inulin", qty: 15 },
      { ingId: "eigelb", qty: 40 },
      { ingId: "salz", qty: 2 },
    ],
    notes:
      "Optimiert · Trockenglukose und Inulin kompensieren den Wegfall des Invertzuckers bei hoher Standfestigkeit.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- FRUCHTEIS — KLASSISCH --------
  {
    ...
    notes:
      "Optimiert · Inulin sorgt bei Sorbets für einen weniger 'kalten' Schmelz.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "dextrose", qty: 45 },
      { ingId: "glukose-pulver", qty: 20 },
      { ingId: "inulin", qty: 15 },
      { ingId: "wasser", qty: 280 },
    ],
    notes:
      "Optimiert · Hoher Säureanteil wird durch die Textur von Inulin und Trockenglukose abgefedert.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- FRUCHTEIS — MODERN --------
  {
    ...
    rows: [
      ...
      { ingId: "wasser", qty: 100 },
    ],
    notes:
      "Optimiert · Die natürliche Cremigkeit der Mango wird durch Inulin perfekt unterstützt.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Optimiert · Weniger Kristallzucker, dafür mehr Körper durch Inulin.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "wasser", qty: 120 },
    ],
    notes:
      "Optimiert · Inulin hilft die intensive Farbe und Struktur stabil zu halten.",
    createdAt: 0,
    updatedAt: 0,
  },
];
