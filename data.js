...
const DEFAULT_RECIPES = [
  // -------- MILCHEIS — KLASSISCH --------
  {
    ...
    notes:
      "Klassisch · Vanillemark vor dem Pasteurisieren in die Milch einlegen und ziehen lassen.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Klassisch · Kakaopulver und Bitterschokolade in warmer Milch bei 50 °C auflösen, dann Base einrühren.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Klassisch · Haselnusspaste bei ca. 40 °C einrühren. Magermilch statt Vollmilch kompensiert das hohe Fett der Paste.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Klassisch · Reines Milcheis ohne Aromazusätze — die Qualität der Milch kommt voll zum Tragen.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- MILCHEIS — MODERN --------
  {
    ...
    notes:
      "Modern · Saccharose trocken karamellisieren, mit Sahne ablöschen, abkühlen lassen, dann restliche Zutaten einarbeiten.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- FRUCHTEIS — KLASSISCH --------
  {
    ...
    notes:
      "Klassisch · Frische Erdbeeren pürieren und durch ein feines Sieb streichen. Zitronensaft hebt das Aroma.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Klassisch · Frisch gepressten Zitronensaft verwenden. Etwas Zitronenabrieb für mehr Tiefe.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- FRUCHTEIS — MODERN --------
  {
    ...
    notes:
      "Modern · Reife Alphonso-Mangos oder hochwertiges Tiefkühlpüree. Der natürliche Zuckergehalt ist bereits hoch — vorsichtig dosieren.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Modern · Durch ein feines Sieb streichen um Kerne zu entfernen. Intensiv-fruchtige Säure bleibt gut erhalten.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    notes:
      "Modern · Wildheidelbeeren oder Tiefkühlware verwenden. Ein Zweig Rosmarin beim Erhitzen verleiht eine subtile Note.",
    createdAt: 0,
    updatedAt: 0,
  },
];
