...
const DEFAULT_INGREDIENTS = [
  ...
  {
    id: "saccharose",
    name: "Saccharose (Kristallzucker)",
    cat: "Zucker",
    ts: 100.0,
    fett: 0.0,
    zucker: 100.0,
...
const DEFAULT_RECIPES = [
  // -------- MILCHEIS — KLASSISCH --------
  {
    ...
    rows: [
      ...
      { ingId: "sahne35", qty: 184 },
      { ingId: "saccharose", qty: 92 },
      { ingId: "dextrose", qty: 43 },
      { ingId: "glukose-pulver", qty: 18 },
      { ingId: "inulin", qty: 15 },
      { ingId: "vanille-mark", qty: 4 },
    ],
    notes:
      "Optimiert · 30 g Milchbase auf 1000 g Mix · Inulin verbessert die Textur; Invertzucker wurde durch Dextrose/Trockenglukose ersetzt.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "sahne35", qty: 165 },
      { ingId: "saccharose", qty: 71 },
      { ingId: "dextrose", qty: 35 },
      { ingId: "glukose-pulver", qty: 24 },
      { ingId: "inulin", qty: 14 },
      { ingId: "kakao", qty: 35 },
      { ingId: "schoko-70", qty: 59 },
    ],
    notes:
      "Optimiert · 30 g Milchbase auf 1000 g Mix · Hoher Kakaoanteil benötigt Inulin für bessere Bindung und Cremigkeit.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "magermilchpulver", qty: 27 },
      { ingId: "saccharose", qty: 94 },
      { ingId: "dextrose", qty: 27 },
      { ingId: "glukose-pulver", qty: 27 },
      { ingId: "inulin", qty: 16 },
      { ingId: "haselnuss-pasta", qty: 108 },
    ],
    notes:
      "Optimiert · 30 g Milchbase auf 1000 g Mix · Haselnussfett wird durch Inulin und Trockenglukose in der Textur stabilisiert.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "sahne35", qty: 143 },
      { ingId: "magermilchpulver", qty: 18 },
      { ingId: "saccharose", qty: 84 },
      { ingId: "dextrose", qty: 36 },
      { ingId: "glukose-pulver", qty: 18 },
      { ingId: "inulin", qty: 14 },
    ],
    notes:
      "Optimiert · 30 g Milchbase auf 1000 g Mix · Reiner Geschmack, durch Inulin besonders zartschmelzend.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- MILCHEIS — MODERN --------
  {
    ...
    rows: [
      ...
      { ingId: "sahne35", qty: 185 },
      { ingId: "saccharose", qty: 86 },
      { ingId: "dextrose", qty: 37 },
      { ingId: "glukose-pulver", qty: 37 },
      { ingId: "inulin", qty: 19 },
      { ingId: "eigelb", qty: 49 },
      { ingId: "salz", qty: 2 },
    ],
    notes:
      "Optimiert · 30 g Milchbase auf 1000 g Mix · Trockenglukose und Inulin kompensieren den Wegfall des Invertzuckers bei hoher Standfestigkeit.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- FRUCHTEIS — KLASSISCH --------
  {
    ...
    rows: [
      ...
      { ingId: "saccharose", qty: 148 },
      { ingId: "dextrose", qty: 49 },
      { ingId: "glukose-pulver", qty: 19 },
      { ingId: "inulin", qty: 12 },
      { ingId: "zitrone-saft", qty: 25 },
      { ingId: "wasser", qty: 99 },
    ],
    notes:
      "Optimiert · 30 g Fruchtbase auf 1000 g Mix · Inulin sorgt bei Sorbets für einen weniger 'kalten' Schmelz.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "saccharose", qty: 179 },
      { ingId: "dextrose", qty: 57 },
      { ingId: "glukose-pulver", qty: 26 },
      { ingId: "inulin", qty: 19 },
      { ingId: "wasser", qty: 357 },
    ],
    notes:
      "Optimiert · 30 g Fruchtbase auf 1000 g Mix · Hoher Säureanteil wird durch die Textur von Inulin und Trockenglukose abgefedert.",
    createdAt: 0,
    updatedAt: 0,
  },
  // -------- FRUCHTEIS — MODERN --------
  {
    ...
    rows: [
      { ingId: "base-frucht", qty: 30 },
      { ingId: "mango", qty: 628 },
      { ingId: "saccharose", qty: 126 },
      { ingId: "dextrose", qty: 25 },
      { ingId: "glukose-pulver", qty: 31 },
      { ingId: "inulin", qty: 15 },
      { ingId: "zitrone-saft", qty: 19 },
      { ingId: "wasser", qty: 126 },
    ],
    notes:
      "Optimiert · 30 g Fruchtbase auf 1000 g Mix · Die natürliche Cremigkeit der Mango wird durch Inulin perfekt unterstützt.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "saccharose", qty: 161 },
      { ingId: "dextrose", qty: 43 },
      { ingId: "glukose-pulver", qty: 25 },
      { ingId: "inulin", qty: 15 },
      { ingId: "zitrone-saft", qty: 19 },
      { ingId: "wasser", qty: 87 },
    ],
    notes:
      "Optimiert · 30 g Fruchtbase auf 1000 g Mix · Weniger Kristallzucker, dafür mehr Körper durch Inulin.",
    createdAt: 0,
    updatedAt: 0,
  },
  {
    ...
    rows: [
      ...
      { ingId: "saccharose", qty: 125 },
      { ingId: "dextrose", qty: 44 },
      { ingId: "glukose-pulver", qty: 25 },
      { ingId: "inulin", qty: 15 },
      { ingId: "zitrone-saft", qty: 13 },
      { ingId: "wasser", qty: 149 },
    ],
    notes:
      "Optimiert · 30 g Fruchtbase auf 1000 g Mix · Inulin hilft die intensive Farbe und Struktur stabil zu halten.",
    createdAt: 0,
    updatedAt: 0,
  },
];
